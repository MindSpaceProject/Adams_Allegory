...
public class KitchenDialogue : MonoBehaviour {
    ...
    void OnMouseOver() {
        ...
        // Dad updates
            ...
            if (Input.GetKeyDown(KeyCode.Return) && buttonWasClicked == true) {
                ...
                AdamPlaysGame.chapterScore += tempValue;
        ...
        // Adam updates to end conversation
    ...
    void EndDialogue() {
        isTalking = false;
        dialogueUI.SetActive(false);
        Debug.Log("Final Chapter Score: " + AdamPlaysGame.chapterScore);
        ChapterTransition.chapter = 3;
